...
## Quickstart
In this example you'll will create a Route and then call it.

Let's start by creating a Route. Route is an entry that tell Trickster: *"When I later call you with this request, give me back these data."*
...
You can test it by calling: `curl --location --request GET '/endpoint'`.
